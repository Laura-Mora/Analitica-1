...
# --------- Preparaci?n de variables TEST ---------

df_test <- read_excel("testelco.xlsx")
save <- data.frame(df_test$id)
...
names(df_test)[1] = "Factura_online"
names(df_test)[2] = "Antig?edad_Equipo"
names(df_test)[3] = "Plan_de_datos"
names(df_test)[9] = "tipo_cliente_1"
names(df_test)[10] = "tipo_cliente_2"
names(df_test)[11] = "tipo_cliente_3"


#Select model
names(save)[1] = "id"
predict_1 = predict(report, newdata=df_test, type = "prob")

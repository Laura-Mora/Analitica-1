if (!require('corrplot')) install.packages('corrplot') #matriz de correlación
if (!require('tidyverse')) install.packages('tidyverse')
if (!require('psych')) install.packages('psych')
if (!require('RColorBrewer')) install.packages('RColorBrewer') #poner colores matriz
if (!require('factoextra')) install.packages('factoextra')
if (!require('reshape2')) install.packages('reshape2') #pintar centroides
if (!require('FactoMineR')) install.packages('FactoMineR') #componentes principales
...
# Las variables suplementarias se representan en la soluci?n factorial en 
# t?rminos de su correlaci?n con las componentes principales.
frifact$quanti.sup
frifact$ind$coord
...
fviz_eig(frifact, geom="line", choice="eigenvalue", ylim=c(0,14),
         main = "Gr?fico de codo - Valores propios",
         addlabels = TRUE, xlab = "N?mero de componentes", 
         ylab="Valores propios")

fviz_eig(frifact, geom="bar", ylim=c(0,50),
         main = "Gr?fico de codo - Varianza explicada",
         addlabels = TRUE, xlab = "N?mero de componentes", 
         ylab="Porcentaje de varianza explicado")
...
#contribuci?n de variables e individuos
fviz_contrib(frifact,choice="var", axes=1,
             title = "Contribuci?n de variables a la PC1")
fviz_contrib(frifact,choice="ind", 
             title = "Contribuci?n de individuos a la PC1")

# Visualizaci?n de la soluci?n PCA
...
# Gr?ficos de individuos sobre plano factorial
